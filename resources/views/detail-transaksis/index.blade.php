            ...
            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('detail-transaksis.edit', $detail->id_detail) }}" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="{{ route('detail-transaksis.destroy', $detail->id_detail) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus detail ini? Stok akan dikembalikan.')">
                                @csrf
                                @method('DELETE')
